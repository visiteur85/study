 ...
 //1. Напи ш ите функ ц и ю diff , которая полу ч ает в ка ч естве
 // параметров 2 ч исла и возвра щ ает разни ц у между
 // наиболь ш им и наимень ш им.
 ...
 //4. *Напи
 // ш ите функ ц и ю pow (a, x), которая верн ё т
 // зна ч ение ч исла a , возвед ё нного в степень x
 //  function pow(a, x) {
 //     return Math.pow(a, x)};
 //     pow(2, 9); 
 ...
 //4.5.2 LocalStorage
 //При первом входе пользователя на сайт запросить его
 // имя. При каждом следующем входе - приветстовать 
 // его по имени с помощью браузерного оповещения
